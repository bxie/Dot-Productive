function init(){
	...
	*********************************************/
    ...
    var red9 = createRandomSprite(playSpriteSheet,"shop", null, 0.0, false);
    ...
    var blk7 = createRandomSprite(workSpriteSheet, "pset",null, 0.0, true);
    var blk8 = createRandomSprite(workSpriteSheet, "pset",null, 0.0, true);
    var blk9 = createRandomSprite(workSpriteSheet, "pset",null, 0.0, true);
	...
	*/
	...
	function createRandomSprite(spriteSheet, spriteName, scale, timeAlive, isProductive){
		...
		task = createSprite(spriteSheet, spriteName, x, y, timeAlive, isProductive);
		task.scaleX = scale;
		task.scaleY = scale;
